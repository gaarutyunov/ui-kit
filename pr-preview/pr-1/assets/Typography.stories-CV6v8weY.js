const s={title:"Foundations/Typography",tags:["autodocs"],parameters:{docs:{description:{component:"Geist Sans for UI and body, Geist/Fira Mono for code and labels — the same families used across the source projects."}}}},e={render:()=>`
  ...
  `};var o,a,t;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => \`
    <div style="display:flex; flex-direction:column; gap:18px; color:var(--ga-fg);">
      <div style="font-size:var(--ga-fs-3xl); line-height:1.1; letter-spacing:-0.02em; font-weight:600;">
        Display — depth from a single photo
  ...
  \`
}`,...(t=(a=e.parameters)==null?void 0:a.docs)==null?void 0:t.source}}};const n=["Scale"];export{e as Scale,n as __namedExportsOrder,s as default};
